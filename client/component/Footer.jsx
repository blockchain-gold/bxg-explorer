      ...
      <div className="footer">
        <div className="footer__block">
          ...
          <span className="footer__legal">
            <div>Copyright &copy; 2018 - 2019 <a href="https://blockchaingold.games/">Blockchain Gold Cryptocurrency</a></div>
            <div>Site design / Logo &copy; 2018 - 2019 <a href="https://blockchaingold.games/">Blockchain Gold Cryptocurrency</a></div>
          </span>
        </div>
        <div className="footer__block">
        ...
        <div className="footer__block">
          <div className="footer__social-media-wrapper">
            ...
            <div>
              <a href="https://bitcointalk.org/index.php?topic=" target="_blank">
                <Icon name="bitcoin" className="fab footer__social-media-icon" />
              </a>
              <a href="https://discord.gg/dTJwtzp" target="_blank">
                <Icon name="discord" className="fab footer__social-media-icon" />
              </a>
              <a href="https://t.me/BxGold" target="_blank">
                <Icon name="telegram" className="fab footer__social-media-icon" />
              </a>
              <a href="https://github.com/blockchain-gold" target="_blank">
                <Icon name="github" className="fab footer__social-media-icon" />
              </a>
              <a href="https://twitter.com/BlockchainGold" target="_blank">
